    ...
    return Center(
      child: Container(
        ...
        child: FutureBuilder<List<VolunteerHistory>>(
          future: getUserEmail().then((userEmail) {
            if (userEmail != null) {
              return volunteersProvider.getVolunteerHistory(userEmail);
            } else {
              return Future.error('User email is null');
            }
          }),
    ...
    return Center(
      child: Container(
        ...
        child: FutureBuilder<List<DonationHistory>>(
          future: getUserEmail().then((userEmail) {
            if (userEmail != null) {
              return donationsProvider.getDonationHistory(userEmail);
            } else {
              return Future.error('User email is null');
            }
          }),
